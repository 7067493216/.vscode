...
console.log(fullPathOfFile);
  //1. CHECK IF IT IS A FILE or folder
        //lstatSync gives the information regarding the link provide ,
      ...
      //  //1.2 get folder name from extension
        let folderName = getFolderName(ext); //archives
       console.log(folderName);
        //1.3 copy from src folder(srcPath) and paste in dest folder(folder_name e.g. documents,media etc)
